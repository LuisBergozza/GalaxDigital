      ...
      <div className="container mx-auto px-6 sm:px-8 md:px-10 lg:px-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 md:gap-8">
          {items.map((item, index) => (
            <div key={index} className="galax-stat-item text-center group cursor-default flex items-center justify-center p-3 md:p-4 rounded-xl border border-white/5 md:border-none bg-white/5 md:bg-transparent hover:bg-white/10 md:hover:bg-transparent transition-all">
